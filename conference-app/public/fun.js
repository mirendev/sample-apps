...
const prefixes = ['Mega', 'Ultra', 'Hyper', 'Quantum', 'Cosmic', 'Turbo', 'Ninja', 'Rocket', 'Lightning', 'Thunder'];
const middles = ['Code', 'Tech', 'Dev', 'Hack', 'Data', 'Cloud', 'Web', 'Stack', 'Byte', 'Pixel'];
const suffixes = ['Con', 'Fest', 'Summit', 'Palooza', 'Jam', 'Conf', 'Expo', 'Symposium', 'Gathering', 'Fiesta'];
